...
### Week 5 Objectives:
- Approach and research an overview of Compute Services on the AWS platform.
- Study foundational theories regarding virtual servers (Amazon EC2) and serverless computing (AWS Lambda).
- Conduct a preliminary evaluation of each service to guide future implementation strategies for backend components.
...
* Mastered foundational cloud compute concepts, distinguishing between virtual server provisioning (EC2) and serverless code execution (Lambda).
* Clearly understood appropriate use cases for each service to apply to realistic operational problems in the future.
* Built up initial analytical skills regarding high-level architectures, preparing well for the formalization of the project architecture Proposal.