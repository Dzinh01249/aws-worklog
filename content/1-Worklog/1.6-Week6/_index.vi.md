...
Mục tiêu tuần 6:
- Mục tiêu là tích hợp cơ sở dữ liệu cho hệ thống. Thiết lập Amazon RDS (Relational Database Service) một cách an toàn bên trong mạng nội bộ VPC, sau đó viết code Backend để kết nối, tương tác và quản lý dữ liệu thông qua Object-Relational Mapping (ORM).
