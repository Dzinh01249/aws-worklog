...
Mục tiêu tuần 3:
- Triển khai chính thức toàn bộ mã nguồn Frontend đã xây dựng lên môi trường mạng thực tế. Kết hợp sử dụng Amazon S3 để lưu trữ tĩnh và Amazon CloudFront làm mạng phân phối nội dung (CDN) nhằm đảm bảo tốc độ tải trang cực nhanh ở bất kỳ đâu trên thế giới. Việc này cũng đòi hỏi cấu hình DNS một cách chính xác để người dùng có thể truy cập hệ thống mượt mà.
