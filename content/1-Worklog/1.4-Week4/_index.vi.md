...
Mục tiêu tuần 4:
- Tuần thứ 4 nhằm mục đích hiện đại hóa quy trình phát triển bằng cách loại bỏ việc deploy thủ công tốn thời gian. Mục tiêu là thiết lập một luồng CI/CD (Continuous Integration / Continuous Deployment) hoàn toàn tự động bằng GitHub Actions cho ứng dụng Frontend. Sự cải tiến này là bắt buộc trong bất kỳ dự án phần mềm chuyên nghiệp nào hiện nay.
