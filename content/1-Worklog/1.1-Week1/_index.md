...
| 6 | Navigate the AWS Console with a 5 labs bassic to get used to the management interface and learn how the Free Tier credit system operates. | 23/04/2026 | 23/04/2026 | <https://cloudjourney.awsstudygroup.com/> |

### Week 1 Achievements:

* Formed an initial overview of cloud infrastructure and distinguished basic service groups (Compute, Storage, Network, Database).
* Successfully configured IAM security permissions (avoiding Root account usage for standard operations) on the new AWS account.
* Successfully configured and tested the local Hugo interface in preparation for building the personal workshop site.