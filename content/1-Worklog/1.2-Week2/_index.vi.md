...
Mục tiêu tuần 2:
- Mục tiêu của tuần này là xây dựng nền móng giao diện người dùng (Frontend) sử dụng ReactJS, tập trung vào trải nghiệm người dùng (UX) và giao diện trực quan (UI), đồng thời nghiên cứu các kỹ thuật cần thiết để chuẩn bị đưa ứng dụng lên môi trường đám mây AWS S3. Quá trình phát triển Frontend cần tuân thủ nghiêm ngặt các nguyên tắc thiết kế responsive để tương thích với đa thiết bị.
