...
Bên cạnh các hoạt động kỹ thuật chuyên môn, tôi đã tham gia một cách chủ động vào **ba hội thảo học thuật và chuyên đề công nghệ** xoay quanh Kiến trúc Cloud, Trí tuệ nhân tạo giọng nói (Voice AI) và Định hướng phát triển sự nghiệp. Các diễn đàn này không chỉ đóng vai trò xúc tác trong việc mở rộng nhãn quan công nghệ mà còn giúp tôi lượng hóa rõ rệt khoảng cách giữa môi trường học thuật và các yêu cầu kỹ thuật khắt khe của doanh nghiệp.
